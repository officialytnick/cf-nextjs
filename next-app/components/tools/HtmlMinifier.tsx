...
export default function HtmlMinifier() {
  ...
  return (
    <div className="bg-white dark:bg-[#202124] rounded-xl p-6 border border-gray-200 dark:border-gray-800 space-y-4">
      <div>
        <label htmlFor="html-input" className="block text-sm font-medium mb-2 text-gray-700 dark:text-gray-300">HTML Input</label>
        <div className="relative">
          <textarea id="html-input" value={input} onChange={(e) => setInput(e.target.value)} placeholder="Paste your HTML here..." className="w-full h-40 p-4 border border-gray-300 dark:border-gray-700 rounded-md font-mono text-sm bg-gray-50 dark:bg-gray-900 text-gray-800 dark:text-white resize-none" />
      ...
      <div className="flex gap-3">
        <button onClick={handleMinify} className="bg-red-500 hover:bg-red-600 text-white px-4 py-2 rounded">Minify HTML</button>
